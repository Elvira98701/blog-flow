...
BlogFlow — блог-платформа с системой аутентификации, управлением постами и статистикой пользователей, созданная на Next.js, TypeScript и TanStack Query. Проект реализует полный цикл взаимодействия с контентом: от регистрации и создания постов до их редактирования и анализа активности через Dashboard. В проекте также используются NextAuth, Zod и React Hook Form для безопасной авторизации и валидации данных, а Nodemailer обеспечивает отправку писем пользователям.
